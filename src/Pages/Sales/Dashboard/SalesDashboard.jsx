...
import { useGetBadgesSalesBookingDataQuery, useGetSaleBookingGridStatusCountQuery, useGetSaleBookingStatusListQuery, useGetTop20AccountsQuery, useGetWeeklyMonthlyQuarterlyListQuery } from '../../../Redux/Slices/SalesSlices/SalesDashboardApi';
...
const SalesDashboard = () => {
    ...
    } = useGetTop20AccountsQuery({ userId: loginUserId, isAdmin: loginUserRole == 1 });

    const {
        data: weekMonthCard,
        isLoading: weekMonthCardLoading,
        isError: weekMonthCardError,
    } = useGetWeeklyMonthlyQuarterlyListQuery({ userId: loginUserId, isAdmin: loginUserRole == 1 });
    const {
        data: userBadgeData,
