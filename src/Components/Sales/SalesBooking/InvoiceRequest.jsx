...
import { useGetInvoiceParticularListQuery } from "../../../Redux/Slices/SalesSlices/InvoiceParticularApi";
...
const InvoiceRequest = ({
  ...
  const [addInvoice, { isLoading: isInvoiceSubmitting }] =
  ...
  return (
    <div>
      ...
      <div className="flex-row gap-2">
        ...
        <div className="mt-2">
          <button
            className="btn-primary btn btn_sm mt-4"
            onClick={() => {
              setIsModalOpen(true);
            }}
          >
