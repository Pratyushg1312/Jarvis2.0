import Diamond from "/assets/images/badge/diamond.png";
import Platinum from "/assets/images/badge/platinum.png";
import Gold from "/assets/images/badge/gold.png";
import Silver from "/assets/images/badge/silver.png";
import Bronze from "/assets/images/badge/bronze.png";
import Basic from "/assets/images/badge/iron.png";
                ...
                <div className="stepWrapper">
                    <ol className="steps">
                        ...
                        {badgeData?.map((badge, index) => (
                            <li
                                key={index}
                                className={`step ${userBadgeData?.totalCampaignAmount > badge.min_rate_amount &&
                                    "stepActive"
