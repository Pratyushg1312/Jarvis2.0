...
function convertNumberToIndianString(num) {
  ...
  function convertLargeNumbers(n) {
    for (const unit of units) {
      if (n >= unit.value) {
        ...
        return (
          convertNumberToIndianString(unitPart) +
          " " +
          unit.label +
          (remainder ? " " + convertNumberToIndianString(remainder) : "")
        );
      }
    }
...
export default convertNumberToIndianString;
